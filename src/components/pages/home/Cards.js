...
const Cards = () => {
  return (
    <Grid>
      ...
      <Card image="images/image03.webp" title="Semester project 2" description="Code stack is a fictional wikipage for front end development. This project was part of my semester project for the second year." githubLink="https://github.com/Janne-R/semester-project-2-new" />
